    ...
    if counterlogin==1:
        ...
        def savebill():
            ...
            if  BlIdentity.get() == "" or BlName.get() == "" or GenderBl.get() == "" or int(BlAge.get()) == "" or Blcheckin.get() == ""  or BlDisease.get() == "" or int(BlPhone.get()) == "" or BlDoctorname.get() == "" or Blcheckout.get() == ""  or int(BlDoctorcharges.get()) == "" or int(BlLabtest.get()) == "" or int(TreatmentchargesBl.get()) == "" or int(BlProcedurecharges.get()) == "" or int(BlOthercharges.get()) == "" or int(BlMiscellaneouscharges.get()) == "" or int(BlRoomcharges.get()) == "":
            	result = tkMessageBox.showwarning('', 'Please Complete The Requiblack Field', icon="warning")      
            else:
            	connection=sqlite3.connect("YASH.db")
            	cursor=connection.cursor()
        ...
        def appointment():
            ...
            if counterappointment==1:
                frameappointment=Frame(root,bg="silver")
                ...
                labelappointment=Label(frameappointmentleft,text="Appointment:-",bg="silver",fg="black",font=("calibri",30,"bold"))
                labelappointment.pack(anchor="nw")

                frameappointmentlef=Frame(frameappointment,bg="silver",height=500,width=500)
                frameappointmentlef.pack(side=TOP,pady=25)

                patintnoappointment=Label(frameappointmentlef,text="Appointment No:",bg="silver",font=("calibri",20,"bold"))
                ...
                patientnameappointment=Label(frameappointmentlef,text="Patient Name:    ",bg="silver",font=("calibri",20,"bold"))
                ...
                labelGender=Label(frameappointmentlef,text="Gender:               ",bg="silver",font=("calibri",20,"bold"))
                labelGender.grid(row=2,column=0)

                i= IntVar()
                r1 = Radiobutton(frameappointmentlef,text="male",value='Male',variable=GENDERAPPOINTMENT,bg="silver",font=("calibri",20,"bold"))
                r2 = Radiobutton(frameappointmentlef,text="female",value='Female',variable=GENDERAPPOINTMENT,bg="silver",font=("calibri",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)

                labelItemName=Label(frameappointmentlef,text="Age:                 ",bg="silver",font=("calibri",20,"bold"))
                ...
                labelQuantity=Label(frameappointmentlef,text="Phone No:         ",bg="silver",font=("calibri",20,"bold"))
                ...
                labelItemName=Label(frameappointmentlef,text="Address:         ",bg="silver",font=("calibri",20,"bold"))
                ...
                labelGender=Label(frameappointmentlef,text="Time/Date:        ",bg="silver",font=("calibri",20,"bold"))
        ...
        def billrecord():
            ...
            if counterbillrecord==1:
                framebillrecord=Frame(root,relief="solid",borderwidth=2,bg="darkgrey")
                framebillrecord.pack(side="right",fill=BOTH,expand=True)

                frameybillr=Frame(framebillrecord,bg="silver",relief="solid",borderwidth=2)
                frameybillr.pack(side=TOP,fill=X)

                labelbill=Label(frameybillr,text="Bill Record",bg="silver",fg="black",font=("calibri",20,"bold"))
                labelbill.pack()

                frameq=Frame(framebillrecord,width=100,relief="solid",borderwidth=2,bg="darkgrey")
                frameq.pack(side="left",fill=Y)

                labelinputid=Label(frameq,text="Input Patient id",fg="black",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                Searchbutton=Button(frameq,text="Search",command=lambda:Blsearch(searchbillrecord.get()),bg="silver",font=("calibri",15,"bold"))
                Searchbutton.pack(side=TOP,pady=8)

                framezbill=Frame(framebillrecord,bg="silver",relief="solid",borderwidth=2)
                framezbill.pack(side=TOP,fill=X)

                

                frametbill=Frame(framebillrecord,height="200",bg="darkgrey")
                frametbill.pack(side=TOP,fill=X)

                framebrleft=Frame(frametbill,height="200",width="685",bg="darkgrey")
                framebrleft.pack(side=LEFT)

                labelPatient_id=Label(framebrleft,text="Identity:",bg="darkgrey",font=("calibri",16,"bold"))
                ...
                labelName=Label(framebrleft,text="Name:",bg="darkgrey",font=("calibri",16,"bold"))
                ...
                labelGender=Label(framebrleft,text="Gender:  ",bg="darkgrey",font=("calibri",16,"bold"))
                labelGender.grid(row=2,column=0)
                                
                i= IntVar()
                r1 = Radiobutton(framebrleft,text="male",value='Male',variable=GenderBlrecord,bg="darkgrey",font=("calibri",16,"bold"))
                r2 = Radiobutton(framebrleft,text="female",value='Female',variable=GenderBlrecord,bg="darkgrey",font=("calibri",16,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderBlrecord.set(3)


                labelAge=Label(framebrleft,text="Age:",bg="darkgrey",font=("calibri",16,"bold"))
                ...
                labelCheckIn=Label(framebrleft,text="Check In:",bg="darkgrey",font=("calibri",16,"bold"))
                ...
                framebrights=Frame(frametbill,height="200",bg="darkgrey",width="685")
                framebrights.pack(side=RIGHT)

                labelAge=Label(framebrights,text="Disease:",bg="darkgrey",font=("calibri",16,"bold"))
                ...
                labelPhone=Label(framebrights,text="Phone:",bg="darkgrey",font=("calibri",16,"bold"))
                ...
                labelAddress=Label(framebrights,text="Address:",bg="darkgrey",font=("calibri",16,"bold"))
                ...
                labelDisease=Label(framebrights,text="Doctor Name:",bg="darkgrey",font=("calibri",16,"bold"))
                ...
                labelCheckOut=Label(framebrights,text="Check Out:",bg="darkgrey",font=("calibri",16,"bold"))
                ...
                framebottomr=Frame(framebillrecord,relief="solid",bg="darkgrey",borderwidth=2)
                framebottomr.pack(side=TOP,fill=X,pady=16)

                labelPatient_id=Label(framebottomr,text="Sr. No :",bg="darkgrey",fg="Purple",font=("calibri",20,"bold"))
                labelPatient_id.grid(row=0,column=0,sticky="w",padx=60)
                labelPatient_id=Label(framebottomr,text="Particulars :",bg="darkgrey",fg="Purple",font=("calibri",20,"bold"))
                labelPatient_id.grid(row=0,column=1,sticky="w",padx=60)
                labelPatient_id=Label(framebottomr,text="Amount :",bg="darkgrey",fg="Purple",font=("calibri",20,"bold"))
                ...
                framebox=Frame(framebillrecord,bg="darkgrey")
                framebox.pack(side=TOP,fill=BOTH,expand=True,pady="10")

                labelPatient_id=Label(framebox,text="01 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelPatient_id.grid(row=0,column=0,sticky="w",padx=70)
                labelPatient_id=Label(framebox,text="Doctor Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelName=Label(framebox,text="02 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelName.grid(row=1,column=0,sticky="w",padx=70)
                labelName=Label(framebox,text="Lab Test:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelGender=Label(framebox,text="03 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelGender.grid(row=2,column=0,sticky="w",padx=70)
                labelGender=Label(framebox,text="Treatment Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelAge=Label(framebox,text="04 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx=70)
                labelAge=Label(framebox,text="Procedure Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelPhone=Label(framebox,text="05 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelPhone.grid(row=4,column=0,sticky="w",padx=70)
                labelPhone=Label(framebox,text="Other Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelAddress=Label(framebox,text="06 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelAddress.grid(row=5,column=0,sticky="w",padx=70)
                labelAddress=Label(framebox,text="Miscellaneous Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelAddress=Label(framebox,text="07 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelAddress.grid(row=6,column=0,sticky="w",padx=70)
                labelAddress=Label(framebox,text="Room Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelDisease=Label(framebox,text="",bg="darkgrey",font=("calibri",17,"bold"))
                labelDisease.grid(row=7,column=0,sticky="w",padx=105)
                labelDisease=Label(framebox,text="Total:",fg="black",bg="darkgrey",font=("calibri",17,"bold"))
        ...
        def Bill():
            ...
            try:
            	...
            	pass
            if counterbill==1:
                framebill=Frame(root,relief="solid",borderwidth=2,bg="darkgrey")
                framebill.pack(side="right",fill=BOTH,expand=True)

                framerecordleft=Frame(framebill,height="60",width="200",relief="solid",borderwidth=2,bg="darkgrey")
                framerecordleft.pack(side=LEFT,fill=Y)

                framepatientbilltop=Frame(framerecordleft,height="100",relief="solid",borderwidth=2,bg="silver")
                framepatientbilltop.pack(side=TOP,fill=X)

                labelinputpatientname=Label(framepatientbilltop,text="Input Patient's ID",bg="silver",font=("calibri",16,"bold"))
                labelinputpatientname.pack(anchor=CENTER,pady=6)

                framepatientadmittopsearch=Frame(framerecordleft,bg="darkgrey")
                ...
                Searchbutton=Button(framepatientadmittopsearch,text="Search",command=lambda:Billsearch(searchID.get()),bg="silver",font=("calibri",15,"bold"))
                Searchbutton.pack(side=TOP,pady=8)

                framexbill=Frame(framebill,bg="silver",relief="solid",borderwidth=2)
                framexbill.pack(side=TOP,fill=X)

                labelbill=Label(framexbill,text="Billing",bg="silver",fg="black",font=("calibri",20,"bold"))
                labelbill.pack()

                frametbill=Frame(framebill,height="200",bg="darkgrey")
                frametbill.pack(side=TOP,fill=X)

                framebleft=Frame(frametbill,height="200",width="685",bg="darkgrey")
                framebleft.pack(side=LEFT)

                labelPatient_id=Label(framebleft,text="Identity:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelName=Label(framebleft,text="Name:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelGender=Label(framebleft,text="Gender:  ",bg="darkgrey",font=("calibri",17,"bold"))
                labelGender.grid(row=2,column=0)
                                
                i= IntVar()
                r1 = Radiobutton(framebleft,text="male",value='Male',variable=GenderBl,bg="darkgrey",font=("calibri",16,"bold"))
                r2 = Radiobutton(framebleft,text="female",value='Female',variable=GenderBl,bg="darkgrey",font=("calibri",16,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderBl.set(3)

                labelAge=Label(framebleft,text="Age:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                checkin=Label(framebleft,text="Check In:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                framebright=Frame(frametbill,height="200",bg="darkgrey",width="685")
                framebright.pack(side=RIGHT)

                labelAge=Label(framebright,text="Disease:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelPhone=Label(framebright,text="Phone:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelAddress=Label(framebright,text="Address:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelDisease=Label(framebright,text="Doctor Name:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelCheckOut=Label(framebright,text="Check Out:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                framebottom=Frame(framebill,relief="solid",bg="darkgrey",borderwidth=2)
                framebottom.pack(side=TOP,fill=X,pady=16)

                labelPatient_id=Label(framebottom,text="Sr. No :",bg="darkgrey",fg="Purple",font=("calibri",20,"bold"))
                labelPatient_id.grid(row=0,column=0,sticky="w",padx=55)
                labelPatient_id=Label(framebottom,text="Particulars :",bg="darkgrey",fg="Purple",font=("calibri",20,"bold"))
                labelPatient_id.grid(row=0,column=1,sticky="w",padx=10)
                labelPatient_id=Label(framebottom,text="Amount :",bg="darkgrey",fg="Purple",font=("calibri",20,"bold"))
                ...
                framebo=Frame(framebill,bg="darkgrey")
                framebo.pack(side=TOP,fill=BOTH,expand=True,pady="10")

                labelPatient_id=Label(framebo,text="01 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelPatient_id.grid(row=0,column=0,sticky="w",padx=75)
                labelPatient_id=Label(framebo,text="Doctor Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                labelPatient_id.grid(row=0,column=1,sticky="w",padx=10)
                ...
                labelName=Label(framebo,text="02 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelName.grid(row=1,column=0,sticky="w",padx=75)
                labelName=Label(framebo,text="Lab Test:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelGender=Label(framebo,text="03 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelGender.grid(row=2,column=0,sticky="w",padx=75)
                labelGender=Label(framebo,text="Treatment Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelAge=Label(framebo,text="04 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx=75)
                labelAge=Label(framebo,text="Procedure Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelPhone=Label(framebo,text="05 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelPhone.grid(row=4,column=0,sticky="w",padx=75)
                labelPhone=Label(framebo,text="Other Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelAddress=Label(framebo,text="06 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelAddress.grid(row=5,column=0,sticky="w",padx=75)
                labelAddress=Label(framebo,text="Miscellaneous Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelAddress=Label(framebo,text="07 :",bg="darkgrey",font=("calibri",17,"bold"))
                labelAddress.grid(row=6,column=0,sticky="w",padx=75)
                labelAddress=Label(framebo,text="Room Charges:",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelDisease=Label(framebo,text="",bg="darkgrey",font=("calibri",17,"bold"))
                labelDisease.grid(row=7,column=0,sticky="w",padx=75)
                labelDisease=Button(framebo,text="Total:",command=total,bg="silver",font=("calibri",17,"bold"))
                ...
                frameprint=Frame(framebill,bg="darkgrey")
                frameprint.pack(side=RIGHT)

                buttonadd=Button(frameprint,text="SAVE",bg="silver",command=savebill,bd=3,width=10,font=("calibri",15,"bold"))
                buttonadd.pack(side=LEFT)

                buttonPrint=Button(frameprint,text="Print",bg="silver",command=printbill,bd=3,width=10,font=("calibri",15,"bold"))
        ...
        def sinfo():
            ...
            if countersinfo==1:
                framestaffinformation=Frame(root,bg="darkgrey",)
                framestaffinformation.pack(side="right",fill=BOTH,expand=True)

                framestaffinformationtop=Frame(framestaffinformation,height="200",relief="solid",bg="silver",borderwidth=2)
                framestaffinformationtop.pack(side=TOP,fill=X)

                labelstaffinformation=Label(framestaffinformationtop,text="Staff Information",bg="silver",font=("calibri",23,"bold"))
                labelstaffinformation.pack(anchor="center")

                framestaffinformationleft=Frame(framestaffinformation,height="60",width="300",bg="darkgrey",relief="solid",borderwidth=2)
                framestaffinformationleft.pack(side=LEFT,fill=Y)

                labelUsername=Label(framestaffinformationleft,text="User ID",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                Searchbutton=Button(framestaffinformationleft,text="Search",command=lambda:Sisearch(searchID.get()),bg="silver",font=("calibri",15,"bold"))
                Searchbutton.pack(side=TOP,pady=8)

                framestaffinformationright=Frame(framestaffinformation,height="60",bg="darkgrey",width="300",relief="solid",borderwidth=2)
                framestaffinformationright.pack(side=RIGHT,fill=Y)

                buttonUpdate=Button(framestaffinformationright,text="Update",command=Siupdate,bd=7,bg="silver",width=10,font=("calibri",15,"bold"))
                buttonUpdate.pack(side=TOP,padx="70",pady=100)



                framestaffinformationcenter=Frame(framestaffinformation,height="60",width="130",bg="darkgrey",relief="solid",borderwidth=2)
                framestaffinformationcenter.pack(anchor="center",fill=BOTH,expand=True)

                labelid=Label(framestaffinformationcenter,text="ID:                 ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelName=Label(framestaffinformationcenter,text="Name:            ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelGender=Label(framestaffinformationcenter,text="Gender:          ",bg="darkgrey",font=("calibri",20,"bold"))
                labelGender.grid(row=2,column=0)
                        
                r1 = Radiobutton(framestaffinformationcenter,text="male",value='Male',bg="darkgrey",variable=GenderSi,font=("calibri",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2 = Radiobutton(framestaffinformationcenter,text="female",value='Female',bg="darkgrey",variable=GenderSi,font=("calibri",20,"bold"))
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderSi.set(3)


                labelPosition=Label(framestaffinformationcenter,text="Position:         ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelDepartment=Label(framestaffinformationcenter,text="Department:         ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelMailid=Label(framestaffinformationcenter,text="Mail ID:         ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelSalary=Label(framestaffinformationcenter,text="Salary:            ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelPhone=Label(framestaffinformationcenter,text="Phone:           ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelAddress=Label(framestaffinformationcenter,text="Address:         ",bg="darkgrey",font=("calibri",20,"bold"))
        ...
        def sreg():
            ...
            if countersreg==1:
                framestaffregistration=Frame(root,bg="darkgrey")
                framestaffregistration.pack(side="right",fill=BOTH,expand=True)

                framestaffregistrationtop=Frame(framestaffregistration,height="200",bg="silver",relief="solid",borderwidth=2,)
                framestaffregistrationtop.pack(side=TOP,fill=X)

                labelstaffregistration=Label(framestaffregistrationtop,text="Staff Registration",bg="silver",font=("calibri",23,"bold"))
                labelstaffregistration.pack(anchor="center")

                framestaffregistrationcenter=Frame(framestaffregistration,height="60",width="130",relief="solid",bg="darkgrey",borderwidth=2)
                framestaffregistrationcenter.pack(side=LEFT,fill=BOTH,expand=True)

                labelid=Label(framestaffregistrationcenter,text="ID:                 ",bg="darkgrey",font=("calibri",21,"bold"))
                ...
                labelName=Label(framestaffregistrationcenter,text="Name:            ",bg="darkgrey",font=("calibri",21,"bold"))
                labelName.grid(row=1,column=0,padx=10,pady=15)
                ...
                labelGender=Label(framestaffregistrationcenter,text="Gender:          ",bg="darkgrey",font=("calibri",21,"bold"))
                labelGender.grid(row=2,column=0)

                i= IntVar()
                r1 = Radiobutton(framestaffregistrationcenter,text="male",value="Male",bg="darkgrey",variable=GenderSr,font=("calibri",20,"bold"))
                r2 = Radiobutton(framestaffregistrationcenter,text="female",value="Female",variable=GenderSr,bg="darkgrey",font=("calibri",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderSr.set(3)

                labelPosition=Label(framestaffregistrationcenter,text="Position:         ",bg="darkgrey",font=("calibri",21,"bold"))
                labelPosition.grid(row=3,column=0,padx=10,pady=15)
                ...
                labelDepartment=Label(framestaffregistrationcenter,text="Department:         ",bg="darkgrey",font=("calibri",21,"bold"))
                labelDepartment.grid(row=4,column=0,padx=10,pady=15)
                ...
                labelMailid=Label(framestaffregistrationcenter,text="Mail ID:         ",bg="darkgrey",font=("calibri",21,"bold"))
                labelMailid.grid(row=5,column=0,padx=10,pady=15)
                ...
                labelSalary=Label(framestaffregistrationcenter,text="Salary:            ",bg="darkgrey",font=("calibri",21,"bold"))
                labelSalary.grid(row=6,column=0,padx=10,pady=15)
                ...
                labelPhone=Label(framestaffregistrationcenter,text="Phone:           ",bg="darkgrey",font=("calibri",21,"bold"))
                labelPhone.grid(row=7,column=0,padx=10,pady=15)
                ...
                labelAddress=Label(framestaffregistrationcenter,text="Address:         ",bg="darkgrey",font=("calibri",21,"bold"))
                labelAddress.grid(row=8,column=0,padx=10,pady=15)
                ...
                framestaffregistrationright=Frame(framestaffregistration,height="60",width="300",bg="darkgrey",relief="solid",borderwidth=2)
                framestaffregistrationright.pack(side=RIGHT,fill=Y)

                buttonAdd=Button(framestaffregistrationright,text="ADD",command=Sradd,bd=7,bg="silver",width=10,font=("calibri",15,"bold"))
        ...
        def ainfo():
            ...
            if counterainfo==1: 
                frameainfo=Frame(root,width=100,height=100,bg="darkgrey")
                frameainfo.pack(side="right",fill=BOTH,expand=TRUE)

                frameainfotop=Frame(frameainfo,height="200",relief="solid",borderwidth=2,bg="silver")
                frameainfotop.pack(side=TOP,fill=X)

                labelpatientinfotext=Label(frameainfotop,text="Admit Information",bg="silver",font=("calibri",23,"bold"))
                labelpatientinfotext.pack(anchor="center")

                frameainfoleft=Frame(frameainfo,height="60",width="300",relief="solid",bg="darkgrey",borderwidth=2)
                frameainfoleft.pack(side=LEFT,fill=Y)

                labelinputpatientname=Label(frameainfoleft,text="Input Patient's ID",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                Search1button=Button(frameainfoleft,text="Search",command=lambda: Aisearch(searchID.get()),bg="silver",font=("calibri",15,"bold"))
                Search1button.pack(side=TOP,pady=8)

                frameainfocenter=Frame(frameainfo,height="60",width="130",relief="solid",bg="darkgrey",borderwidth=2)
                frameainfocenter.pack(side=LEFT,fill=BOTH,expand=True)

                labelPatientid=Label(frameainfocenter,text="Patient ID:    ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelPatientid=Label(frameainfocenter,text="",bg="darkgrey",font=("calibri",20,"bold"))
                labelPatientid.grid(row=0,column=2,sticky="e")

                labelName=Label(frameainfocenter,text="Name:       ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelGender=Label(frameainfocenter,text="Gender:        ",bg="darkgrey",font=("calibri",20,"bold"))
                labelGender.grid(row=2,column=0)
                        
                i= IntVar()
                r1 = Radiobutton(frameainfocenter,text="male",value=1,variable=GenderAi,bg="darkgrey",font=("calibri",20,"bold"))
                r2 = Radiobutton(frameainfocenter,text="female",value=2,variable=GenderAi,bg="darkgrey",font=("calibri",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderAi.set(3)

                labelAge=Label(frameainfocenter,text="Age:         ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelPhone=Label(frameainfocenter,text="Phone:     ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelAddress=Label(frameainfocenter,text="Address:  ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelDisease=Label(frameainfocenter,text="Disease:   ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelCheckIn=Label(frameainfocenter,text="Check In",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                frameainforight=Frame(frameainfo,height="60",width="300",relief="solid",borderwidth=2,bg="darkgrey")
                frameainforight.pack(side=RIGHT,fill=Y)

                labelBloodgroup=Label(frameainforight,text="Blood Group",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelDoctorname=Label(frameainforight,text="Doctor Name",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelCheckOut=Label(frameainforight,text="Check OUT",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelRoomNo=Label(frameainforight,text="Room No.",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelRoomType=Label(frameainforight,text="Room Type",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelPrice=Label(frameainforight,text="Price.",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                Updatebutton=Button(frameainforight,text="Update",command=Aiupdate,bg="silver",width=15,bd=7,font=("calibri",15,"bold"))
        ...
        def padmit():
            ...
            if counterpadmit==1:    
                framepatientadmit=Frame(root,width=100,bg="darkgrey",height=100)
                framepatientadmit.pack(side="right",fill=BOTH,expand=TRUE)

                frameainfoleft=Frame(framepatientadmit,height="60",width="200",relief="solid",borderwidth=2,bg="darkgrey")
                frameainfoleft.pack(side=LEFT,fill=Y)

                framepatientadmittop=Frame(frameainfoleft,height="200",relief="solid",borderwidth=2,bg="silver")
                framepatientadmittop.pack(side=TOP,fill=X)

                labelinputpatientname=Label(framepatientadmittop,text="Input Patient's ID",bg="silver",font=("calibri",17,"bold"))
                labelinputpatientname.pack(anchor=CENTER,pady=10)

                framepatientadmittopsearch=Frame(frameainfoleft,bg="darkgrey")
                framepatientadmittopsearch.pack(side=TOP)
                ...
                Searchbutton=Button(framepatientadmittopsearch,text="Search",command=lambda:Adsearch(searchID.get()),bg="silver",font=("calibri",15,"bold"))
                Searchbutton.pack(side=TOP,pady=8)

                framepatientadmittop=Frame(framepatientadmit,height="200",relief="solid",borderwidth=2,bg="silver")
                framepatientadmittop.pack(side=TOP,fill=X)

                labelpatientrinfotext=Label(framepatientadmittop,text="Patient Admit",bg="silver",font=("calibri",23,"bold"))
                labelpatientrinfotext.pack(anchor="center")

                framepatientadmitcenter=Frame(framepatientadmit,height="60",width="130",bg="darkgrey",relief="solid",borderwidth=2)
                framepatientadmitcenter.pack(side=LEFT,fill=BOTH,expand=True)

                labelPatientid=Label(framepatientadmitcenter,text="Patient ID:    ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelName=Label(framepatientadmitcenter,text="Name:       ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelGender=Label(framepatientadmitcenter,text="Gender:        ",bg="darkgrey",font=("calibri",20,"bold"))
                labelGender.grid(row=2,column=0)
                        
                i= IntVar()
                r1 = Radiobutton(framepatientadmitcenter,text="male",value=1,variable=GenderPa,bg="darkgrey",font=("calibri",20,"bold"))
                r2 = Radiobutton(framepatientadmitcenter,text="female",value=2,variable=GenderPa,bg="darkgrey",font=("calibri",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderPa.set(3)

                labelAge=Label(framepatientadmitcenter,text="Age:         ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelPhone=Label(framepatientadmitcenter,text="Phone:     ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelAddress=Label(framepatientadmitcenter,text="Address:  ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelDisease=Label(framepatientadmitcenter,text="Disease:   ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelCheckIn=Label(framepatientadmitcenter,text="Check In",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                framepatientadmitright=Frame(framepatientadmit,height="60",width="300",relief="solid",bg="darkgrey",borderwidth=2)
                framepatientadmitright.pack(side=RIGHT,fill=Y)

                labelBloodgroup=Label(framepatientadmitright,text="Blood group",bg="darkgrey",font=("calibri",17,"bold"))
                labelBloodgroup.pack(padx=80,pady=10)
                ...
                labelDoctorname=Label(framepatientadmitright,text="Doctor Name",bg="darkgrey",font=("calibri",17,"bold"))
                labelDoctorname.pack(padx=80,pady=10)
                ...
                labelCheckOut=Label(framepatientadmitright,text="Check OUT",bg="darkgrey",font=("calibri",17,"bold"))
                labelCheckOut.pack(pady=10)
                ...
                labelRoomNo=Label(framepatientadmitright,text="Room No.",bg="darkgrey",font=("calibri",17,"bold"))
                labelRoomNo.pack(pady=10)
                ...
                labelRoomType=Label(framepatientadmitright,text="Room Type",bg="darkgrey",font=("calibri",17,"bold"))
                labelRoomType.pack(pady=10)
                ...
                labelPrice=Label(framepatientadmitright,text="Price.",bg="darkgrey",font=("calibri",17,"bold"))
                labelPrice.pack(pady=10)
                ...
                ADDAbutton=Button(framepatientadmitright,text="ADD",command=Paadd,bg="silver",width=15,bd=7,font=("calibri",15,"bold"))
        ...
        def rinfo():
            ...
            if counterrinfo==1: 
                ...
                framerinfotop=Frame(framerinfo,height="200",relief="solid",borderwidth=2,bg="silver")
                framerinfotop.pack(side=TOP,fill=X)

                labelpatientrinfotext=Label(framerinfotop,text="Registration Information",bg="silver",font=("calibri",23,"bold"))
                labelpatientrinfotext.pack(anchor="center")

                framerinfoleft=Frame(framerinfo,height="60",width="300",relief="solid",borderwidth=2,bg="darkgrey")
                framerinfoleft.pack(side=LEFT,fill=Y)

                labelinputpatientname=Label(framerinfoleft,text="Input Patient's ID",bg="darkgrey",font=("calibri",17,"bold"))
                labelinputpatientname.pack(anchor=CENTER,pady=20)
                ...
                Searchbutton=Button(framerinfoleft,text="Search",command=lambda:Risearch(searchID.get()),bg="silver",font=("calibri",15,"bold"))
                Searchbutton.pack(side=TOP,pady=8)

                framerinfocenter=Frame(framerinfo,height="60",width="130",bg="darkgrey",relief="solid",borderwidth=2)
                framerinfocenter.pack(side=LEFT,fill=BOTH,expand=True)

                labelPatientid=Label(framerinfocenter,text="Patient ID:    ",bg="darkgrey",font=("calibri",20,"bold"))
                labelPatientid.grid(row=0,column=0,pady=10,sticky="w")
                ...
                labelPatientid=Label(framerinfocenter,text="",bg="darkgrey",font=("calibri",20,"bold"))
                labelPatientid.grid(row=0,column=2,sticky="e")

                labelName=Label(framerinfocenter,text="Name:       ",bg="darkgrey",font=("calibri",20,"bold"))
                labelName.grid(row=1,column=0,padx=0,pady=17,sticky="w")
                ...
                labelGender=Label(framerinfocenter,text="Gender:        ",bg="darkgrey",font=("calibri",20,"bold"))
                labelGender.grid(row=2,column=0)
                        
                
                r1 = Radiobutton(framerinfocenter,text="male",value='Male',variable=GenderRi,bg="darkgrey",font=("calibri",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2 = Radiobutton(framerinfocenter,text="female",value='Female',variable=GenderRi,bg="darkgrey",font=("calibri",20,"bold"))
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderRi.set(3)


                labelAge=Label(framerinfocenter,text="Age:         ",bg="darkgrey",font=("calibri",20,"bold"))
                labelAge.grid(row=3,column=0,sticky="w",padx=0,pady=17)
                ...
                labelPhone=Label(framerinfocenter,text="Phone:     ",bg="darkgrey",font=("calibri",20,"bold"))
                labelPhone.grid(row=4,column=0,sticky="w",padx=0,pady=17)
                ...
                labelAddress=Label(framerinfocenter,text="Address:  ",bg="darkgrey",font=("calibri",20,"bold"))
                labelAddress.grid(row=5,column=0,sticky="w",padx=0,pady=17)
                ...
                labelDisease=Label(framerinfocenter,text="Disease:   ",bg="darkgrey",font=("calibri",20,"bold"))
                labelDisease.grid(row=6,column=0,sticky="w",padx=0,pady=17)
                ...
                labelCheckIn=Label(framerinfocenter,text="Check In",bg="darkgrey",font=("calibri",20,"bold"))
                labelCheckIn.grid(row=7,column=0,sticky="w",padx=0,pady=17)
                ...
                framerinforight=Frame(framerinfo,height="60",width="300",bg="darkgrey",relief="solid",borderwidth=2)
                framerinforight.pack(side=RIGHT,fill=Y)

                labelDoctorname=Label(framerinforight,text="Blood Group",bg="darkgrey",font=("calibri",17,"bold"))
                labelDoctorname.pack(padx=80,pady=10)
                ...
                labelDoctorname=Label(framerinforight,text="Doctor Name",bg="darkgrey",font=("calibri",17,"bold"))
                labelDoctorname.pack(padx=80,pady=10)
                ...
                labelDoctorname=Label(framerinforight,text="Room No",bg="darkgrey",font=("calibri",17,"bold"))
                labelDoctorname.pack(padx=80,pady=10)
                ...
                Updatebutton=Button(framerinforight,text="Update",command=Riupdate,bg="silver",bd=7,font=("calibri",15,"bold"))
                Updatebutton.pack(side=RIGHT,padx=35,pady=100)

                Updatebutton=Button(framerinforight,text="Receipt",command=Rireceipt,bg="silver",bd=7,font=("calibri",15,"bold"))
                Updatebutton.pack(side=RIGHT,padx=35,pady=100)
        ...
        def Receipt():
            ...
            try:
            	...
            	pass
            if counterreceipt==1:
                framereceiptimage=Frame(root,bg="darkgrey")
                ...
                label=Label(framereceiptimage,text="NH-62, Pali Road,Kudi Haud, Jodhpur Rajasthan",font=("calibri",15,"bold"),bg="darkgrey")
                ...
                framereceipt=Frame(root,bg="darkgrey")
                framereceipt.pack(side="top",fill=BOTH,expand=True)

                

                framereceipttop=Frame(framereceipt,bg="darkgrey",height=20)
                framereceipttop.pack(side=TOP,fill=X)

                labelreceipt=Label(framereceipttop,text="Receipt :-",bg="darkgrey",fg="black",font=('arial',20,'bold'))
                ...
                labelreceipt=Label(framereceipt,text="Medicine: - ",fg="black",bg="darkgrey",font=('arial',20,'bold'))
                labelreceipt.pack(anchor="nw",padx=150,pady=10)

                buttonprint=Button(framereceipt,text="Print",width=7,fg="black",font=('arial',20,'bold'),command=iPrint)
        ...
        def Rireceipt():
            ...
            if counterrireceipt==1:
                framerireceiptimage=Frame(root,bg="darkgrey")
                ...
                label=Label(framerireceiptimage,text="NH-62, Pali Road,Kudi Haud, Jodhpur Rajasthan",font=("calibri",15,"bold"),bg="darkgrey")
                label.grid(row=0,column=1,padx=200)
                ...
                framerireceipt=Frame(root,bg="darkgrey")
                framerireceipt.pack(side="top",fill=BOTH,expand=True)

                

                framerireceipttop=Frame(framerireceipt,bg="darkgrey",height=20)
                framerireceipttop.pack(side=TOP,fill=X)

                labelreceipt=Label(framerireceipttop,text="Receipt :-",bg="darkgrey",fg="black",font=('arial',20,'bold'))
                labelreceipt.pack(side=LEFT,padx=150,pady=10)
                ...
                labelreceipt=Label(framerireceipt,text="Medicine: - ",fg="black",bg="darkgrey",font=('arial',20,'bold'))
                labelreceipt.pack(anchor="nw",padx=150,pady=10)

                buttonprint=Button(framerireceipt,text="Print",width=7,fg="black",font=('arial',20,'bold'),command=iPrint)
                buttonprint.pack(side=BOTTOM)
        ...
        def printbill():
            ...
            if counterprintbill==1:
                frameprintbill=Frame(root,bg="darkgrey")
                ...
                buttonbill=Button(frameprintbill,text="Print",font=('arial',12,'bold'),fg="black",command=billPrint)
        ...
        def preg():
            ...
            if counterpreg==1:
                framepatientregistration=Frame(root,width=100,height=100,bg="darkgrey")
                framepatientregistration.pack(side="right",fill=BOTH,expand=TRUE)

                framepatientregistrationtop=Frame(framepatientregistration,height="200",relief="solid",borderwidth=2,bg="silver")
                framepatientregistrationtop.pack(side=TOP,fill=X)

                labelpatientregistrationtext=Label(framepatientregistrationtop,text="Patient Registration",bg="silver",font=("calibri",23,"bold"))
                labelpatientregistrationtext.pack(anchor="center")

                framepatientregistrationcenter=Frame(framepatientregistration,bg="darkgrey",height="60",width="130",relief="solid",borderwidth=2)
                framepatientregistrationcenter.pack(side=LEFT,fill=BOTH,expand=True)

                labelPatientid=Label(framepatientregistrationcenter,bg="darkgrey",text="Patient ID:    ",font=("calibri",20,"bold"))
                ...
                labelName=Label(framepatientregistrationcenter,text="Name:       ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelGender=Label(framepatientregistrationcenter,text="Gender:    ",bg="darkgrey",font=("calibri",20,"bold"))
                labelGender.grid(row=2,column=0,sticky="w",padx=90)

                i= IntVar()
                r1 = Radiobutton(framepatientregistrationcenter,text="male",value="Male",bg="darkgrey",variable=GenderPr,font=("calibri",20,"bold"))
                r2 = Radiobutton(framepatientregistrationcenter,text="female",value="Female",bg="darkgrey",variable=GenderPr,font=("calibri",20,"bold"))
                r1.grid(row=2,column=1,sticky="w")
                r2.grid(row=2,column=1,sticky="e",padx=0)
                GenderPr.set(3)

                labelAge=Label(framepatientregistrationcenter,text="Age:         ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelPhone=Label(framepatientregistrationcenter,text="Phone:     ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelAddress=Label(framepatientregistrationcenter,text="Address:  ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelDisease=Label(framepatientregistrationcenter,text="Disease:   ",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                labelCheckIn=Label(framepatientregistrationcenter,text="Check IN",bg="darkgrey",font=("calibri",20,"bold"))
                ...
                framepatientregistrationright=Frame(framepatientregistration,height="60",width="300",bg="darkgrey",relief="solid",borderwidth=2)
                framepatientregistrationright.pack(side=RIGHT,fill=Y)

                labelBloodgroup=Label(framepatientregistrationright,text="Blood Group",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelDoctorname=Label(framepatientregistrationright,text="Doctor Name",bg="darkgrey",font=("calibri",17,"bold"))
                ...
                labelRoomNo=Label(framepatientregistrationright,text="Room No.",bg="darkgrey",font=("calibri",17,"bold"))
                labelRoomNo.pack(pady=10)
                ...
                ADDAbutton=Button(framepatientregistrationright,text="ADD",command=Pradd,bg="silver",width=10,bd=7,font=("calibri",15,"bold"))
                ADDAbutton.pack(side=LEFT,padx=5)

                buttonprintreg=Button(framepatientregistrationright,text="Receipt",command=Receipt,bg="silver",width=10,bd=7,font=("calibri",15,"bold"))
                buttonprintreg.pack(side=LEFT,padx=5)

        framemenuroot=Frame(root,height="190",bg="darkgrey")
        framemenuroot.pack(side=TOP,fill=X)
        framehospitalname=Label(framemenuroot,text="                                  DTU HOSPITAL",bg="darkgrey",fg="black",width="35",font=("calibri",27,"bold"))
        ...
        framemenubackground=Frame(root,bg="darkgrey",height="60",width="50")
        framemenubackground.pack(side=LEFT,fill=Y)
        framemenuheading=Label(framemenubackground,text="Menu",fg="White",bg="silver",width="25",font=("calibri",18,"bold"))
        framemenuheading.pack(anchor="nw")

        homeicon=PhotoImage(file=r"home.png")
        Buttonpatienthome=Button(framemenubackground,text="Home            ",compound=LEFT,image=homeicon,command=home,bd=5,bg="silver",font=("calibri",14,"bold"))
        Buttonpatienthome.pack(side="top",fill=X)

        patientregistrationicon=PhotoImage(file=r"patientregistration.png")
        Buttonpatientregistration=Button(framemenubackground,text="Patient Registration         ",compound=LEFT,image=patientregistrationicon,command=preg,bd=5,bg="silver",font=("calibri",14,"bold"))
        Buttonpatientregistration.pack(side="top",fill=X)

        patientadmiticon=PhotoImage(file=r"patientadmit.png")
        Buttonpatientinformation=Button(framemenubackground,text="Patient Admit                     ",compound=LEFT,image=patientadmiticon,command=padmit,bd=5,bg="silver",font=("calibri",14,"bold"))
        Buttonpatientinformation.pack(side="top",fill=X)

        registrationinformationicon=PhotoImage(file=r"patientinformation.png")
        Buttonregistrationinfo=Button(framemenubackground,text="Registration Information",compound=LEFT,image=registrationinformationicon,command=rinfo,bd=5,bg="silver",font=("calibri",14,"bold"))
        Buttonregistrationinfo.pack(side="top",fill=X)

        admitinformationicon=PhotoImage(file=r"patientadmit.png")
        Buttonadmitinformation=Button(framemenubackground,text="Admit Information            ",compound=LEFT,image=admitinformationicon,command=ainfo,bd=5,bg="silver",font=("calibri",14,"bold"))
        Buttonadmitinformation.pack(side="top",fill=X)

        doctorregistrationicon=PhotoImage(file=r"doctorregistration.png")
        Buttonstaffregistration=Button(framemenubackground,text="Staff Registration              ",compound=LEFT,image=doctorregistrationicon,command=sreg,bd=5,bg="silver",font=("calibri",14,"bold"))
        Buttonstaffregistration.pack(side="top",fill=X)

        doctorinformationicon=PhotoImage(file=r"doctorinformation.png")
        Buttonstaffinformation=Button(framemenubackground,text="Staff Information               ",compound=LEFT,image=doctorinformationicon,command=sinfo,bd=5,bg="silver",font=("calibri",14,"bold"))
        Buttonstaffinformation.pack(side="top",fill=X)

        registrationrecordicon=PhotoImage(file=r"registrationrecord.png")
        ButtonRegistrationRecord=Button(framemenubackground,text="Registration Record         ",compound=LEFT,image=registrationrecordicon,command=RRecord,bd=5,bg="silver",font=("calibri",14,"bold"))
        ButtonRegistrationRecord.pack(side="top",fill=X)

        admitrecordicon=PhotoImage(file=r"admitrecord.png")
        ButtonAdmitRecord=Button(framemenubackground,text="Admit Record                    ",compound=LEFT,image=admitrecordicon,command=AdmitRecord,bd=5,bg="silver",font=("calibri",14,"bold"))
        ButtonAdmitRecord.pack(side="top",fill=X)

        doctorrecordicon=PhotoImage(file=r"doctorrecord.png")
        ButtonStaffRecord=Button(framemenubackground,text="Staff Record                        ",compound=LEFT,image=doctorrecordicon,command=drecord,bd=5,bg="silver",font=("calibri",14,"bold"))
        ButtonStaffRecord.pack(side="top",fill=X)

        generatebillicon=PhotoImage(file=r"generatebill.png")
        ButtonBill=Button(framemenubackground,text="Generate Bill                       ",compound=LEFT,image=generatebillicon,command=Bill,bd=5,bg="silver",font=("calibri",14,"bold"))
        ButtonBill.pack(side="top",fill=X)

        billrecordicon=PhotoImage(file=r"recordbill.png")
        ButtonBill=Button(framemenubackground,text="Bill Record                             ",compound=LEFT,image=billrecordicon,command=billrecord,bd=5,bg="silver",font=("calibri",14,"bold"))
        ButtonBill.pack(side="top",fill=X)

        appointmenticon=PhotoImage(file=r"appointment.png")
        Buttonappointment=Button(framemenubackground,text="Appointment                       ",compound=LEFT,image=appointmenticon,bd=5,bg="silver",font=("calibri",14,"bold"),command=appointment)
        Buttonappointment.pack(side="top",fill=X)


    else:
        messagebox.showinfo("INVALID USERNAME OR PASSWORD ", "YOU HAVE ENTEblack INVALID USERNAME OR PASSWORD  ")
...
buttonok=Button(userright,text="LOGIN",bg="silver",height=2,width=6,bd=3,font=("calibri",12,"bold"),command=login)
buttonok.pack(side=LEFT,padx="10",pady="10")

buttonexit=Button(userright,text="EXIT",bg="silver",height=2,width=6,bd=3,font=("calibri",12,"bold"),command=exit)
